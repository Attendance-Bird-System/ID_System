...
# search in group using id or name
class GroupPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        csv_but = Button(rightPropframe, relief=FLAT, bg="#3F3F3F",
                          image=csv_icon,
        ...
        archived_but = Button(rightPropframe, relief=FLAT, bg="#3F3F3F",
                          image=archived_icon,
        ...
        remove_but = Button(rightPropframe, relief=FLAT, bg="#3F3F3F",
                          image=remove_icon,
        ...
        csv_but.pack(side=BOTTOM,)
        archived_but.pack(side=BOTTOM,)
        remove_but.pack(side=BOTTOM)
